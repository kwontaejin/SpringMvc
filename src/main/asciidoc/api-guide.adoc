...
==== Response Field
include::{snippets}\doc-documentation\test1\response-fields.adoc[]

==== Example Request
include::{snippets}\doc-documentation\test1\http-request.adoc[]

==== Example response

include::{snippets}\doc-documentation\test1\http-response.adoc[]